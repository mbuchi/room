...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'market.ranges_indicative': 'Per-room ranges are indicative (±20% of average).',
  ...
  fr: {
    ...
    'market.ranges_indicative': 'Les plages par pièce sont indicatives (±20 % de la moyenne).',
  ...
  de: {
    ...
    'market.ranges_indicative': 'Bereiche pro Zimmer sind Richtwerte (±20 % des Durchschnitts).',
  ...
  it: {
    ...
    'market.ranges_indicative': 'Gli intervalli per locale sono indicativi (±20% della media).',
