...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'panel.restype.single_unit': 'Single-unit',
    'panel.restype.multi_unit': 'Multi-unit',
    ...
    'panel.info.header_fallback': 'Selected parcel',
    'panel.info.egrid_copy': 'Copy EGRID',
    'panel.info.egrid_copied': 'Copied',
    'panel.info.latlng_label': 'WGS84',
    ...
    'panel.info.section.zoning_location': 'Zoning & Location',
    'panel.info.section.building': 'Building',
    'panel.info.section.market': 'Market',
    ...
    'panel.info.ratio_v.label': 'ratioV (volume utilization)',
    'panel.info.ratio_v.no_reference': 'No reference allowed-utilization for this zone.',
    ...
    // ---------- Market (MarketDataSection — RealAdvisor city figures) ----------
    'market.toggle.rent': 'Rent',
    'market.toggle.buy': 'Buy',
    'market.toggle.apartments': 'Apartments',
    'market.toggle.houses': 'Houses',
    ...
    'market.ranges_indicative': 'Per-room ranges are indicative (±20% around the median).',
    'market.for_rent_count': '{count} for rent',
    'market.for_sale_count': '{count} for sale',
    'market.room.studio': 'Studio',
    'market.room.2': '2 rms',
    'market.room.3': '3 rms',
    'market.room.4': '4 rms',
    'market.room.5': '5 rms',
    ...
    'panel.zone.percentile_title': 'Zone utilization percentile',
    'panel.zone.percentile_label': 'percentile',
    'panel.zone.gauge_aria': 'Percentile gauge',
    'panel.zone.over_time_title': 'Utilization over time',
    ...
    'panel.zone.summary.p50_title': 'Median ratioV of the parcels built in this window',
    ...
    'tour.welcome.body': "room answers one question: how densely is this zone already built? Search or click a parcel and you'll see exactly where it sits on its zone's utilization distribution.",
  ...
  fr: {
    ...
    'panel.restype.single_unit': 'Un logement',
    'panel.restype.multi_unit': 'Plusieurs logements',
    ...
    'panel.info.header_fallback': 'Parcelle sélectionnée',
    'panel.info.egrid_copy': 'Copier l’EGRID',
    ...
    'panel.info.section.zoning_location': 'Zonage et localisation',
    'panel.info.section.building': 'Bâtiment',
    'panel.info.section.market': 'Marché',
    ...
    // ---------- Marché (MarketDataSection — données RealAdvisor par ville) ----------
    'market.toggle.rent': 'Location',
    'market.toggle.buy': 'Achat',
    'market.toggle.apartments': 'Appartements',
    'market.toggle.houses': 'Maisons',
    'market.median': 'médiane',
    ...
    'market.legend.max': 'max',
    'market.ranges_indicative': 'Les plages par pièce sont indicatives (±20 % autour de la médiane).',
    'market.for_rent_count': '{count} à louer',
    'market.for_sale_count': '{count} à vendre',
    'market.room.studio': 'Studio',
    'market.room.2': '2 p.',
    'market.room.3': '3 p.',
    'market.room.4': '4 p.',
    ...
    'panel.zone.summary.p50_label': 'p50',
    'panel.zone.summary.p50_title': 'ratioV médian des parcelles construites dans cette période',
  ...
  de: {
    ...
    'panel.restype.single_unit': 'Eine Einheit',
    'panel.restype.multi_unit': 'Mehrere Einheiten',
    ...
    'panel.info.header_fallback': 'Ausgewählte Parzelle',
    'panel.info.egrid_copy': 'EGRID kopieren',
    ...
    'panel.info.section.zoning_location': 'Zonierung & Standort',
    'panel.info.section.building': 'Gebäude',
    'panel.info.section.market': 'Markt',
    ...
    // ---------- Markt (MarketDataSection — RealAdvisor-Stadtdaten) ----------
    'market.toggle.rent': 'Miete',
    'market.toggle.buy': 'Kauf',
    'market.toggle.apartments': 'Wohnungen',
    'market.toggle.houses': 'Häuser',
    'market.median': 'Median',
    ...
    'market.legend.median': 'Median',
    'market.legend.max': 'Max.',
    'market.ranges_indicative': 'Bereiche pro Zimmer sind Richtwerte (±20 % um den Median).',
    'market.for_rent_count': '{count} zu vermieten',
    'market.for_sale_count': '{count} zu verkaufen',
    'market.room.studio': 'Studio',
    'market.room.2': '2 Zi.',
    'market.room.3': '3 Zi.',
    'market.room.4': '4 Zi.',
    ...
    'panel.zone.summary.p50_label': 'p50',
    'panel.zone.summary.p50_title': 'Median des ratioV der in diesem Zeitraum gebauten Parzellen',
  ...
  it: {
    ...
    'panel.restype.single_unit': 'Unità singola',
    'panel.restype.multi_unit': 'Più unità',
    ...
    'panel.info.header_fallback': 'Particella selezionata',
    'panel.info.egrid_copy': 'Copia EGRID',
    ...
    'panel.info.section.zoning_location': 'Zonizzazione e localizzazione',
    'panel.info.section.building': 'Edificio',
    'panel.info.section.market': 'Mercato',
    ...
    // ---------- Mercato (MarketDataSection — dati RealAdvisor per città) ----------
    'market.toggle.rent': 'Affitto',
    'market.toggle.buy': 'Acquisto',
    'market.toggle.apartments': 'Appartamenti',
    'market.toggle.houses': 'Case',
    ...
    'market.legend.max': 'max',
    'market.ranges_indicative': 'Gli intervalli per locale sono indicativi (±20% attorno alla mediana).',
    'market.for_rent_count': '{count} in affitto',
    'market.for_sale_count': '{count} in vendita',
    'market.room.studio': 'Monolocale',
    'market.room.2': '2 loc.',
    'market.room.3': '3 loc.',
    'market.room.4': '4 loc.',
    'market.room.5': '5 loc.',
    ...
    'panel.zone.summary.p50_label': 'p50',
    'panel.zone.summary.p50_title': 'ratioV mediano delle particelle costruite in questo periodo',
...
// Provider + hook are now generated by the suite-shared createI18n factory
