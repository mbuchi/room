...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'tour.track_parcel.body': 'Found a parcel worth watching? Track it to save it to your proom workspace, where it syncs across the whole SwissNovo suite. Open it later in proom in one click. (Sign in to enable.)',
  ...
  fr: {
    ...
    'tour.track_parcel.body': 'Une parcelle à surveiller ? Suivez-la pour l’enregistrer dans votre espace proom, synchronisé dans toute la suite SwissNovo. Rouvrez-la ensuite dans proom en un clic. (Connectez-vous pour activer.)',
  ...
  de: {
    ...
    'tour.track_parcel.body': 'Eine Parzelle, die Sie im Auge behalten wollen? Verfolgen Sie sie, um sie in Ihrem proom-Arbeitsbereich zu speichern, synchronisiert über die ganze SwissNovo-Suite. Öffnen Sie sie später in proom mit einem Klick. (Zum Aktivieren anmelden.)',
  ...
  it: {
    ...
    'tour.track_parcel.body': 'Una particella da tenere d’occhio? Seguila per salvarla nel tuo spazio proom, sincronizzato in tutta la suite SwissNovo. Riaprila poi in proom con un clic. (Accedi per attivare.)',
