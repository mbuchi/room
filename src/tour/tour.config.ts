  ...
  variants: {
    ...
    long: [
      ...
      },
      {
        ...
        body: "The Parcel facts tab lists the municipality, zoning category, parcel area, existing building volume, year built and the utilization figures (ratioV, freeV) - the raw numbers behind the density score.",
      ...
      },
      {
        ...
        body: "The Zone distribution tab plots the whole zone: a boxplot, utilization histograms, a percentile gauge and a parcel-area-vs-volume scatter - each marked with your parcel, so you can see at a glance whether it's under- or over-built versus its peers.",
        i18nKey: "tour.charts",
        placement: "left",
      },
      {
