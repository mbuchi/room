    ...
    long: [
      {
        ...
        body: "room answers one question: how densely is this zone already built? Search or click a parcel and you'll see exactly where it sits on its zone's utilization distribution.",
      ...
      },
      {
        ...
        body: "The Parcel tab lists the municipality, zoning category, parcel area, existing building volume, year built and the utilization figures (ratioV, freeV) - the raw numbers behind the density score. Market, Massing and FAQ sit beside it as their own tabs.",
      ...
      },
      {
        ...
        body: "The Zone tab plots the whole zone in one scroll: a percentile gauge, a boxplot, utilization histograms, a utilization-over-time line and a parcel-area-vs-volume scatter - each marked with your parcel, so you can see at a glance whether it's under- or over-built versus its peers.",
        i18nKey: "tour.charts",
        placement: "left",
      },
      {
