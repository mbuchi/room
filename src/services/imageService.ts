...
export const APP_SOURCE = 'groove';
...
// Known fields produced by the groove capture flow. Extra fields are allowed
// so other apps (or future features) can store flexible context without a
...
// screenshot feature rolls out across the swissnovo product family.
...
// a JWT. Zitadel's access_token can be opaque depending on the app's
// Auth Token Type, but the id_token is always a JWT (RFC 7519) and carries
// sub/name/email under the openid+profile+email scope.
